...
const FALLBACK_content: CmsContent[] = [
  {
    ...
    content_type: 'page',
    title: 'About Us',
    body: '<h1>About MoveFox</h1><p>We help people find trusted removal companies across the UK.</p>',
    meta_description: 'Learn about MoveFox and our mission to simplify moving.',
    published: true,
    sort_order: 1,
    author: null,
    category: null,
  ...
  },
  {
    ...
    meta_description: 'Find out how MoveFox works in three simple steps.',
    published: true,
    sort_order: 2,
    author: null,
    category: null,
  ...
  },
  {
    ...
    body: '<h1>Terms and Conditions</h1><p>By using MoveFox, you agree to the following terms...</p>',
  ...
  },
  {
    ...
    content_type: 'faq',
    title: 'How much does it cost to use MoveFox?',
    body: 'MoveFox is completely free for homeowners. We charge removal companies a small fee to connect with you.',
    meta_description: null,
    published: true,
    sort_order: 2,
    author: null,
  ...
  },
  {
    ...
    body: 'All removal companies on MoveFox must provide proof of insurance, accreditations, and pass our review process.',
    meta_description: null,
    published: true,
    sort_order: 3,
    author: null,
  ...
  },
  {
    ...
    featured_image_url: null,
    read_time_minutes: 8,
    excerpt: 'A comprehensive moving checklist to keep your house move on track from start to finish.',
  ...
  },
  {
    ...
    featured_image_url: null,
    read_time_minutes: 5,
    excerpt: 'Key factors to consider when selecting a removal company for your home move.',
  ...
  },
  {
    ...
    featured_image_url: null,
    read_time_minutes: 6,
    excerpt: 'Professional movers share their best packing secrets to make your move easier.',
